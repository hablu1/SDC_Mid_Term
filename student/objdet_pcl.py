...
def show_pcl(pcl):
    ...
    vis.create_window(width=810, height=540)
    ...
    vis.run()
    vis.register_key_callback(262, update_function(pcd))
...
def show_range_image(frame, lidar_name):
    ...
    stacked_img = np.vstack((img_range, img_intensity))
...
def bev_from_pcl(lidar_pcl, configs):
    ...
    counts = np.count_nonzero(lidar_pcl_top > 0)
